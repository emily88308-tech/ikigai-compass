...
function PageContent({ page }) {
  ...
  if (page === "archived") return <GoalListPane title="Archive" subtitle="Ongoing goals you've retired — kept for history, out of your active view" filterStatus="archived" accentColor="#6E7787" emptyIcon="▤" emptyMsg={"Nothing archived.\nArchive an ongoing goal when you stop tracking it."}/>;
